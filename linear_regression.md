...
Null Hypothesis: There's no relationship between ozone and solar
...
# horizontal line of mean.Ozone
# what the null hypothesis looks like?
abline(h=mean.Ozone)
...
```
qqnorm indicates the residuals in a Normal Distribuation or not
